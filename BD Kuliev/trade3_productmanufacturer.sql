...
CREATE TABLE `productmanufacturer` (
  ...
  `ProductNameManufacturer` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ProductIDManufacturer`)
...
INSERT INTO `productmanufacturer` VALUES (1,'Attache'),(2,'Erich Krause'),(3,'FLEXOFFICE CANDEE'),(4,'GoodMark'),(5,'Hatber'),(6,'Pilot'),(7,'Svetocopy'),(8,'Unimax'),(9,'Комус');
...
-- Dump completed on 2023-07-04 14:24:17
