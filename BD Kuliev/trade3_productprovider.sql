...
CREATE TABLE `productprovider` (
  `ProductIDProvider` int NOT NULL,
  `ProductNameProvider` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ProductIDProvider`)
...
INSERT INTO `productprovider` VALUES (1,'Буквоед'),(2,'Комус');
